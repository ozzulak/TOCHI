...
The the review of SEL in schools have clearly outlined the fundamental role of experiential learning in development of social and emotional skills. We now highlight embedding as the key aspect in which digital technology address and important and existing need within SEL learning. Moreover, we also highlight two other areas where, based on existing work in HCI, we argue use of digital technology could bring novel opportunities to support and enhance current learning. These are in particular support for promoting reflection and awareness of own and others' emotional states, and novel opportunities for practice. 

\todo{Then move onto individual sections already}
...
Second, we saw how the ability to reflect, and become aware of own and others emotions and thoughts underplays all skills taught in SEL; and, more generally, is also understood as the core part of experiential learning. Drawing on the existing HCI work on reflection, albeit currently focused mostly on individuals personal behaviour, we argue that there are great opportunities for digital technology to support also reflective processes underlying the social skills. \\
{\bf Key challenge for HCI}: Reflection current on individual behaviour, initial work supporting emotional tracking, but at the minute mostly everyday pattern tracking (QS). Focus on social aspects is rare, and would pose interesting challenges. 


Third, practice is the second fundamental aspect of experiential learning, and is heavily utilised in the curricula , e.g., in the form of simulation of sel related situations. We again highlight how use of technology, e.g., in the form of novel environment for practice (games, augmented reality, VR...), could provide the learners and curricula designers with a novel opportunities to augment and improve the training. \\
