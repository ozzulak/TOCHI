...
Despite the success of curricula in promoting learning of social and emotional skills to some extent (cf. Section~\ref{sec:reasons}), the review of SEL literature also highlights areas where novel approaches are needed, or further improvements are possible. In the rest of this section, we outline three such exemplary areas---embedding of skills into everyday settings, promoting reflection, and providing mixed spaces for practice. Our choice was motivated by the extent of related HCI work that exists for each of these areas. This allows us to exemplify the potential for collaboration of HCI and SEL, and specifically point to existing HCI work that suggests how incorporating digital technology may help address crucial needs in, as well as open new opportunities for, SEL in education. 
...
%
While such transfer of learned skills is the ultimate goal of all curricula, the current approaches are limited in scope and effectiveness. This leaves teachers (and curricula designers) struggling to directly influence the embedding of skills outside of the SEL learning sessions.
%
...
While existing SEL learning processes are successful in developing students' their reflective abilities to some extent, prior work on supporting reflection in HCI suggests that digital technology has the potential to further extend and augment such training. As already touched upon in Section~\ref{sec:embedding}, providing the learners with previously unavailable cues around, and feedback on, their behaviour could promote, elicit, and scaffold reflection. In the rest of this section, we showcase the possible connections between HCI and SEL by selecting three exemplary areas---support for emotional awareness, mindfulness and relaxation, and communication skills---where initial HCI work has already looked at supporting reflection on topics directly relevant for SEL learning. Altogether, most of the systems referenced below provide indications that they can support and deepen reflection around \emph{specific} emotional or social experiences for the users, which would likely be useful for the learners. However, this also opens interesting questions around if and how similar approaches can be utilised to support the development of reflective \emph{abilities} more generally as part of SEL curricula.
%These are. 
...
We now move on to argue that focus on SEL also presents HCI research with a unique opportunity to explore the potential for supporting social and emotional interaction more broadly.
%
In the rest of this section, we first outline how the structure inherent to SEL curricula could provide HCI with an excellent 'test-bed' to develop, test, and deploy novel technology supporting social and emotional interactions; and second discuss how building on the existing knowledge 
with the SEL community can guide and jump-start HCI research in this area.
...
\TODO{Inconsistent with the text above -- still to be updated from the old version of the paper}
